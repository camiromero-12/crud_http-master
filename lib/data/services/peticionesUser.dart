import 'dart:convert';
import 'package:SocialMascot/domain/models/user.dart';
...
class PeticionesUser {
  static Future<List<Mensajes>> registrarUser(
    ...
    var url = Uri.parse(
        "https://unrewarded-guest.000webhostapp.com/petsAPI/agregarUser.php");
  ...
  static Future<List<User>> validarUser(String u, String p) async {
    var url = Uri.parse(
        "https://unrewarded-guest.000webhostapp.com/petsAPI/validarUser.php");
